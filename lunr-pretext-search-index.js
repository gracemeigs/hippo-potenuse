...
},
{
  ...
  "number": "1.9",
  "title": "Question 9",
  "body": " Question 9  Given the polar coordinate , complete the following.  a. Graph point on the grid.        b. Based on the unit circle, the rectangular coordinates of the point are (___, ___).       c. Show that your answer to part b is correct by converting point to rectangular coordinates.       d. Find another set of polar coordinates for point where .   There are multiple correct answers:   etc.   "
},
{
  "id": "backmatter-2",
  "level": "1",
